# Mavpay Payout FA extension

This extension allows bakers to pay out rewards and bonuses in FA1.2 and FA2 tokens. It supports two base modes:

- **Bonus**: All generated rewards are added on top of the rewards generated by mavpay.
- **Replace**: Replaces rewards generated by mavpay with equivalents converted to FA tokens.
...
extensions: [
    {
        name: payout-fa
        command: "./mavpay_payout-fa" # or .exe based on your platform
        kind: stdio
        hooks: [
