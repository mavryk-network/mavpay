...
const (
	DEFAULT_EMAIL_MESSAGE_TEMPLATE = "A total of <DistributedRewards> was distributed for cycles <Cycles> to <Delegators> delegators and donated <DonatedTotal> using #mavpay on the #mavryk blockchain."
)
