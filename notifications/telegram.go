...
const (
	DEFAULT_TELEGRAM_MESSAGE_TEMPLATE = "A total of <DistributedRewards> was distributed for cycle/s <Cycles> to <Delegators> delegators and donated <DonatedTotal> using #mavpay on the #mavryk blockchain."
)
