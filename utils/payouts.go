...
func FilterPayoutsByType(payouts []*common.AccumulatedPayoutRecipe, t mavryk.AddressType) []*common.AccumulatedPayoutRecipe {
	return lo.Filter(payouts, func(payout *common.AccumulatedPayoutRecipe, _ int) bool {
		return payout.Recipient.Type() == t
	})
}

func RejectPayoutsByType(payouts []*common.AccumulatedPayoutRecipe, t mavryk.AddressType) []*common.AccumulatedPayoutRecipe {
	return lo.Filter(payouts, func(payout *common.AccumulatedPayoutRecipe, _ int) bool {
		return payout.Recipient.Type() != t
	})
}
