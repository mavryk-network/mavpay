...
func PrintCycleSummary(summary common.PayoutSummary, header string) {
	...
	summaryTable.AppendRow(table.Row{"Earned Delegation Rewards", replaceZeroValue(common.MumavToMavS(summary.EarnedRewards.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Earned Block Fees", replaceZeroValue(common.MumavToMavS(summary.EarnedBlockFees.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Earned Total", replaceZeroValue(common.MumavToMavS(summary.EarnedTotal.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Distributed Delegator Rewards", replaceZeroValue(common.MumavToMavS(summary.DistributedRewards.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"NOT Distributed Delegator Rewards", replaceZeroValue(common.MumavToMavS(summary.NotDistributedRewards.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendSeparator()
	summaryTable.AppendRow(table.Row{"Donated Bonds", replaceZeroValue(common.MumavToMavS(summary.DonatedBonds.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Donated Fees", replaceZeroValue(common.MumavToMavS(summary.DonatedFees.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Donated Total", replaceZeroValue(common.MumavToMavS(summary.DonatedTotal.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendSeparator()
	summaryTable.AppendRow(table.Row{"Bond Income", replaceZeroValue(common.MumavToMavS(summary.BondIncome.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Fee Income", replaceZeroValue(common.MumavToMavS(summary.FeeIncome.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Income Total", replaceZeroValue(common.MumavToMavS(summary.IncomeTotal.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Tx Fees Paid For Rewards", replaceZeroValue(common.MumavToMavS(summary.TxFeesPaidForRewards.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.AppendRow(table.Row{"Tx Fees Paid", replaceZeroValue(common.MumavToMavS(summary.TxFeesPaid.Int64()), "-")}, table.RowConfig{AutoMerge: false})
	...
	// summaryTable.AppendRow(table.Row{"NET", replaceZeroValue(common.MumavToMavS(total), "-")}, table.RowConfig{AutoMerge: false})
	summaryTable.Render()
}
